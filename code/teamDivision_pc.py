...
#args load
temp = "롤잘못해요엉엉 싸이클롭s 백업가는중헠헠 다메요 장서누 타푸고양이 라인메탈 왜때리세여 계절학기 필요악"
arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10 = temp.split(" ")
...
for i in range(len(cases)):
    ...
    if i%2 == 1:
        finalText += "\n"
print(finalText)
print('Time Taken: {} seconds'.format(time_took))

arg1= "신나라소녀"
data = pd.read_csv(PATH + '\\summonerNameData.csv', encoding="euc-kr")
if arg1 not in data["summonerName"].values:
    summonerId = getSummonerId(arg1)[0]
    rank = getSummonerRank(summonerId)
else:
